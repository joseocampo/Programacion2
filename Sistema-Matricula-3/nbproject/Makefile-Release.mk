...
${OBJECTDIR}/coleccion.o: coleccion.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/coleccion.o coleccion.cpp
...
${OBJECTDIR}/estudianteExtranjero.o: estudianteExtranjero.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/estudianteExtranjero.o estudianteExtranjero.cpp

${OBJECTDIR}/estudianteNacional.o: estudianteNacional.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/estudianteNacional.o estudianteNacional.cpp
...
${OBJECTDIR}/interfazCurso.o: interfazCurso.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/interfazCurso.o interfazCurso.cpp

${OBJECTDIR}/interfazEscuela.o: interfazEscuela.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/interfazEscuela.o interfazEscuela.cpp

${OBJECTDIR}/interfazProfesor.o: interfazProfesor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/interfazProfesor.o interfazProfesor.cpp

${OBJECTDIR}/interfazSistema.o: interfazSistema.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/interfazSistema.o interfazSistema.cpp

${OBJECTDIR}/interfazUniversidad.o: interfazUniversidad.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/interfazUniversidad.o interfazUniversidad.cpp
